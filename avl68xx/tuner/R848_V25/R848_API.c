...
AVL_uint32 R848_ReadReg(void)
{
    ...
    pTuner_ForR848->usTunerI2CAddr = 0x7A;
    ...
    //_Print("print Reg value begin---tuner lock:\n");
	for( i = 0;i<=index;i++)
	{		  
      _Print("0x%X\n",i2c_para.Data[i]);		 
	}
    _Print("print Reg value end:\n");
    return 0;
}
...
AVL_uint32 R848_Initialize(AVL_Tuner * pTuner )
{
    ...
    if(pTuner->tunerIndex != 0)
        return 1; //not supportted yet
...
AVL_uint32 R848_Lock(AVL_Tuner * pTuner )
{
    ...
    {
        //R848_INFO.R848_Standard = R848_DTMB_6000;//R848_DTMB_IF_5M;
		if(pTuner->uiIFHz == 6*1000*1000)
		{
			R848_INFO.R848_Standard = R848_DTMB_6000;
		}
		else if(pTuner->uiIFHz == 5*1000*1000)
		{
