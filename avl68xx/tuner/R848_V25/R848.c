...
UINT8  R848_Initial_done_flag = R848_FALSE;
UINT8  R848_Initial_xtal_check_flag = R848_FALSE;
UINT8  R848_IMR_done_flag = R848_FALSE;
...
static UINT32 R848_pre_DVBS_bw;
...
R848_Freq_Info_Type R848_Freq_Sel(UINT32 LO_freq, UINT32 RF_freq, R848_Standard_Type R848_Standard)
{
	...
	//LNA band  R13[6:5]
	if(RF_freq<R848_LNA_LOW_LOWEST[R848_SetTfType])  //<164
			  ...
			  if(R848_IMR_done_flag==R848_FALSE)
			  {
				...
				if(R848_TF_Check() != RT_Success)        
				 return RT_Fail;
				  ...
				  if(R848_IMR(3, R848_TRUE) != RT_Success)       //Full K node 3
					return RT_Fail;

				  if(R848_IMR(0, R848_FALSE) != RT_Success)
					return RT_Fail;

				  if(R848_IMR(1, R848_FALSE) != RT_Success)
					return RT_Fail;

				  if(R848_IMR(2, R848_FALSE) != RT_Success)
					return RT_Fail;

				  if(R848_IMR(4, R848_TRUE) != RT_Success)   //Full K node 4
					return RT_Fail;
...
R848_ErrCode R848_Xtal_Check(void)
{
	...
	for(i=0; i<XTAL_CHECK_SIZE; i++) //from weak to strong
	{
		...
		{
			R848_Array[15] = (R848_Array[15] & 0x1F) | ((UINT8)(XTAL_SMALL_HIGHEST-i)<<5) ;   
...
R848_ErrCode R848_SetTF(UINT32 u4FreqKHz, UINT8 u1TfType)
{
	...
	if(u4FreqKHz<R848_LNA_LOW_LOWEST[R848_SetTfType])  //Ultra Low
	{
...
R848_ErrCode R848_DVBS_Setting(R848_Set_Info R848_INFO)
{
	...
	if(R848_PLL(R848_INFO.RF_KHz, R848_INFO.R848_Standard)!= RT_Success)
	{
		return RT_Fail;
	}
	...
	if(R848_INFO.DVBS_BW != R848_pre_DVBS_bw)
	{
		...
		{
			fine_tune=1;
			Coarse =(UINT8)(( R848_INFO.DVBS_BW -67400) /1600)+31;
