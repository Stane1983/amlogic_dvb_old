...
static AVL_uint32 g_uiIgnoreModeFlag[2] = {1, 1};
...
AVL_ErrorCode AVL_Demod_Initialize(AVL_DemodMode eStartupMode, AVL_uint32 uiChipNo)
{
    ...
    AVL_uint32 delay_unit_ms = 20;//the time out window is 100*20=2000ms
    AVL_uint32 i = 0;
    AVL_uint32 j = 0;
    ...
    #if MAIN_TS_SERIAL_DATA7
        gstChipInternalArray[uiChipNo].eTSSerialPin = AVL_MPSP_DATA7;
    #else
        gstChipInternalArray[uiChipNo].eTSSerialPin = AVL_MPSP_DATA0;
    #endif
        gstChipInternalArray[uiChipNo].eTSSerialOrder = AVL_MPBO_MSB;
        gstChipInternalArray[uiChipNo].eTSSerialSyncPulse = AVL_TS_SERIAL_SYNC_1_PULSE;
        gstChipInternalArray[uiChipNo].eTSErrorBit = AVL_TS_ERROR_BIT_DISABLE;
        gstChipInternalArray[uiChipNo].eTSErrorPola = AVL_MPEP_Normal;
        gstChipInternalArray[uiChipNo].eTSValidPola = AVL_MPVP_Normal;
        gstChipInternalArray[uiChipNo].eTSPacketLen = AVL_TS_188;
        gstChipInternalArray[uiChipNo].eTSParallelOrder = AVL_TS_PARALLEL_ORDER_NORMAL;
        gstChipInternalArray[uiChipNo].eTSParallelPhase = AVL_TS_PARALLEL_PHASE_0;

        r |= TunerI2C_Initialize_Demod(uiChipNo);
    }
    else
    {
        g_uiIgnoreModeFlag[uiChipNo] = 0;
...
#if MAIN_TS_SERIAL_DATA7
        r |= SetTSSerialPin_Demod(AVL_MPSP_DATA7, uiChipNo);
#else
...
AVL_ErrorCode AVL_Demod_Set_DVBCStandard(AVL_DVBC_Standard eDVBCStandard, AVL_uint32 uiChipNo)
{
    AVL_ErrorCode r = AVL_EC_OK;
    ...
    if(uiChipNo == 0)
    {
        gstChipInternalArray[uiChipNo].stDVBCPara.eDVBCStandard = eDVBCStandard;
    }
    else if(uiChipNo == 1)
    {
        gstChipInternalArray[uiChipNo].stDVBCPara.eDVBCStandard = eDVBCStandard;
    }
    DVBC_SetStandard_Demod(gstChipInternalArray[uiChipNo].stDVBCPara.eDVBCStandard,uiChipNo);
...
AVL_ErrorCode AVL_Demod_SetMode(AVL_DemodMode eDemodMode,AVL_uint32 uiChipNo)
{
    ...
    if((1 != g_uiIgnoreModeFlag[uiChipNo]) && (gstChipInternalArray[uiChipNo].eCurrentDemodMode == eDemodMode))
    {
        return AVL_EC_OK;
    }
    else if(1 != g_uiIgnoreModeFlag[uiChipNo])
    {
    ...
    if( AVL_EC_OK == r )
    {
        ...
        // Configure the PLL
        if((1 == g_uiIgnoreModeFlag[uiChipNo]) || (gstChipInternalArray[uiChipNo].eCurrentDemodMode != AVL_DVBSX && eDemodMode == AVL_DVBSX) ||
    ...
    if(1 == g_uiIgnoreModeFlag[uiChipNo])
    {
        g_uiIgnoreModeFlag[uiChipNo] = 0;
    }
